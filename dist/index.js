...
function fsm(
    ...
    return function (Component) {
        return _a = /** @class */ (function (_super) {
                ...
                class_1.prototype.transition = function (component, action) {
                    var currentState = this.state.status;
                    var nextStatus = statusMachine[currentState][action.type];
                    if (nextStatus) {
                ...
                class_1.prototype.command = function (nextStatus, action) {
                    var command = commands[nextStatus];
                    if (command) {
                        command(this);
                    }
                };
                class_1.prototype.render = function () {
                    return (React.createElement(Component, __assign({ transition: this.transition, status: this.state.status }, this.props)));
                };
                return class_1;
            }(React.Component)),
            _a.displayName = 'FSM',
